                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h2 className={styles.chatEmptyStateTitle}>Chat with FURS data</h2>
                            <h3 className={styles.chatEmptyStateSubtitle}>Ask question or try an example</h3>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. kako pridobim davčno številko za novorojenčka?)"
                            disabled={isLoading}
